class WelcomeController < ApplicationController
  def index
    ...
    @explanation = [
      ...
      "... but that may change soon... (cue ominous organ music)",
      ...
      "I applied for unemployment for the first time in my life today.  In the comments field, I critized their non-accessible javascript.",
      ...
      "I've helped build sites that sustain 5,000 users simultaneously.",
      "I'm tracking you with Google Analytics, and I'm going to show up at your house looking for work.",
      "... and that could change if you hire me to work at your Seattle-based office on your Ruby on Rails site.",
      "I was fired the day I got back from a week-long vacation at Disneyland.",
      "I'm using my free time wisely (when not job hunting) by making things like this site.",
